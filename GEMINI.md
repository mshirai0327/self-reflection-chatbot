...
-   **コミットメッセージ**: Conventional Commits の形式を推奨します (例: `feat: 新しいチャット機能を追加`)。日本語で記載してください
-   **コメント**: コードに処理に関するコメントをJSDoc形式で、日本語で記載してください。

## Git Rules

- コードの修正が完了したら、変更内容を要約したコミットメッセージを提案してください。
- ユーザーの承認があれば、そのまま `git commit` を実行してください。
- メッセージは Conventional Commits 形式（feat:, fix: など）に従ってください。日本語で記載してください。
